...
过热状态结束后，如果野火还没结束，则立即再补一个高威力战技。特别地，由于<Action name="钻头" />和<Action name="空气锚" />生效较慢，如果你网络延迟较高的话，则不推荐在这里插入这两个技能。
...
机工作为一个纯输出的DPS职业，几乎没有自带任何辅助功能，只有2个团队减伤<Action name="策动" />和<Action name="武装解除" />。
