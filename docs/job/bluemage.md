...
[青魔法师技能列表及学习途径](https://thewakingsands.github.io/blue-mage/)。青魔法师目前的等级上限是60级，会在之后的版本开放新的等级上限。
...
另外极神和零式副本虽不在记录中，但是青魔法师记录中会有每周的极神挑战副本，另外有的副本有单独的成就（需要以等级同步的状态，并且关闭超越之力挑战）。完成指定成就后可以获得<item name="魔界花魔笛" />坐骑。