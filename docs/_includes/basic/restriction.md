...
当前版本零式副本有过本CD限制，即玩家需要**按顺序**挑战M9s → M10s → M11s → M12s才能拿全奖励，跳层将无法拿到被跳过层的奖励。拿过奖励或跳过层的无CD，还有拿奖励资格的层被称为有CD。

::: collapse 举例说明
- ==光之小明==：本周通过M9s（零式阿卡狄亚登天斗技场 轻量级1层）之后，挑战M2s并通过。
小明本周M9s、M10s无CD，M11s、M12s有CD。
- ==暗之小黑==：本周未通过M9s、M10s，直接前往M11s挑战，但未通过。
小黑本周M9s、M10s无CD（俗称黑CD），M11s、M12s有CD。
:::
...
* 通关普通阿卡狄亚登天斗技场 重量级4层之后自动获得的<item name="重量级全息投影利刃" />，每周仅能获得1次。
