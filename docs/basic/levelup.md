...
* <img src="/images/buffs/016227.png" class="no-zoom sm-icon" />++新服奖励++：部分服务器的 89 级以下的职业有 +100% 的经验值加成（该奖励与其他所有加成均为叠乘关系，且适用于所有获得经验的游戏项目，包括但不限于完成任务、讨伐笔记、挑战笔记等等）。
* ++兵装转换奖励++：当前战斗职业等级低于其他战斗职业等级时，获得 +50% 的经验值加成（90级以下时为100%）。（该奖励对Fate结算生效，另外与部队特效有额外的叠乘关系）
