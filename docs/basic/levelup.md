...
* ++休息奖励++：在休息区停留或下线可以累积休息奖励（经验条右下方出现小月亮标记），获得经验时消耗休息奖励并获取 +50% 的经验加成。该奖励有上限，7天叠满，叠满时可以获得额外1级的经验（若没有休息奖励时只能升2级，有叠满的休息奖励时做相同的游戏内容可以升3级）。由于该奖励的计算方式是等级的经验值百分比，所以推荐优先使用高等级的职业消耗休息奖励。<!--https://nga.178.com/read.php?pid=394945214-->
