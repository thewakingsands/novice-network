...
所有UI都是本地化保存的，换电脑就没有了。可以通过复制游戏安装文件夹\最终幻想XIV\game\My Games文件夹来备份键位，也可以通过在登录界面上传来保存键位设置：
...
如果关闭特效后仍有卡顿，可尝试将游戏分辨率缩小，然后使用[MAGPIE](https://github.com/Blinue/Magpie)放大游戏画面，该工具可以将标清窗口画面放大到4K，也可以将小窗口放大到标清。
