...
::: segment blue
++要点：++
- 加点分为两个阶段，第一阶段里，每一组水晶砂和硬灵性岩可以转换成3点属性；加点超过120点后，进入第二阶段，每一组水晶砂和硬灵性岩可能会发生转换暴击，最多可以转换出6点属性。
- 因此这个阶段的加点最多需要80个水晶砂及硬灵性岩。
:::
...
<table class="ui compact grey striped unstackable table">
  ...
  <tr>
    <td>罗薇娜的制作票据</td>
    <td>罗薇娜的制作蓝票票据 x5</td>
    <td>生产红票 x25 兑换(各主城工票交易员)</td>
  </tr>
  <tr>
    <td>罗薇娜的采集票据</td>
    <td>罗薇娜的采集蓝票票据 x5</td>
    <td>采集红票 x25 兑换(各主城工票交易员)</td>
  </tr>
  <tr>
