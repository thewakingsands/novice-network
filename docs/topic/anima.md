...
- 后文所说的所有需要通过诗学点换取的道具，未经特殊说明，则都在奥里亚娜（<Pos name="摩杜纳" :x="22.7" :y="6.7" />）或希丝梅娜(<Pos name="田园郡" :x="5.8" :y="5.3" />)以及6大主城的综合贸易店处交换。
...
- 把任意一把古武+6（本我）交给她，就能直接换到两块水晶。**推荐使用该方案，可以保存古武+6状态，随时购买古武复制品。**
...
::: segment blue 
++要点：++
- 材料入手/兑换方式很多，目前默认是用诗学兑换神秘xx素材，用军票准备生产材料。
- 其他方式仅供参考，如果有材料可以留着。
- 好用工具：[制作进度、材料追踪表](https://www.kdocs.cn/l/cm9hndiVJ8eJ)
...
<table class="ui compact grey striped unstackable table">
  ...
  <tr>
    <td>罗薇娜的制作票据</td>
    <td>罗薇娜的制作蓝票票据 x5</td>
    <td>生产白票 x25 兑换(各主城工票交易员)</td>
  </tr>
  <tr>
    <td>罗薇娜的采集票据</td>
    <td>罗薇娜的采集蓝票票据 x5</td>
    <td>采集白票 x25 兑换(各主城工票交易员)</td>
  </tr>
  <tr>
  ...
  <tr>
    <td rowspan=2>其他2</td>
    <td>玛哈古钱 x2</td>
    <td>完成60级24人大型副本魔航船虚无方舟获得<br><strong>古钱现已无法获得，该兑换无法再继续使用</strong></td>
  </tr>
  <tr>
    <td>亚拉戈魔触媒 x5</td>
...
把人造元灵喂饱饱之后，就可以获得百炼成钢的元灵武器(IL240)了。

如果有需要，也可以随时使用水晶砂再去找乌兰调整属性(…。
...
- <Quest name="安费莉丝的委托" type="plus" />（周常）：需要完成3次随机练级。每周二16点刷新。可以获得 18 个活性化晶簇。
- <Quest name="安格莱特的委托" type="plus" />（日常）：需要完成随机任务：50级/60级/70级/80级后。每天23点刷新。可以获得1个活性化晶簇。
...
++要点：++
- 刷光为10个字(改良型元灵透镜查看)，每个字200点才能完全点亮。
- 2000点刷完后，会提示“人造元灵灵魂完全凝聚了！”
- 通常推荐是A9s(亚历山大零式机神城 天动之章1)，如果队伍输出够高可以压掉小怪阶段，则A10s也可以哦(亚历山大零式机神城 天动之章2)。可以开招募啦~
:::
...
<table class="ui compact grey striped unstackable table">
  ...
  <tr>
    <td>任意版本<a href="/advanced/fate.htm" >临危受命</a></td>
    <td>人造元灵灵魂有了细微的凝聚。</td>
    <td>4</td>
  </tr>
  <tr>
    <td>3.x版本普通蛮神，极武神（罗波那歼殛战），极云神（俾斯麦歼殛战），极骑神（圆桌骑士幻想歼灭战）</td>
    <td>人造元灵灵魂有了一些凝聚。</td>
    <td>8</td>
  </tr>
  <tr>
    <td>普通亚历山大、极邪龙（尼德霍格传奇征龙战）、极魔神（萨菲洛特歼殛战）</td>
    <td>人造元灵灵魂凝聚了！</td>
    <td>16</td>
  </tr>
  <tr>
    <td>50~60副本，极女神（索菲娅歼殛战），极鬼神（祖尔宛歼殛战），战场（尘封秘岩（争夺战）、荣誉野（碎冰战）），零式亚历山大启动之章</td>
    <td>人造元灵灵魂有了很大程度的凝聚！</td>
    <td>32</td>
  </tr>
  <tr>
    <td>60级24人本，零式亚历山大律动之章</td>
