...
生产职业和战斗职业一样，也拥有发光主手（发光工具），主要通过成就和系列任务两种方式获得：

;;;.guide .cols3
;;;.guide .col .figcap
<img src="./craft.assets/SkySteel.png" width="350px" />

天钢系列工具
;;;
;;;.guide .col .figcap
<img src="./craft.assets/Resplendent.jpg" width="350px" />

辉煌系列工具
;;;
;;;.guide .col .figcap
<img src="./craft.assets/Brilliant.jpg" width="350px" />

莫雯卓越/领航星工具
;;;
;;;

* 赐福系列：完成相应数量的制作笔记成就获得。分别有60级（金色）和70级（青银色）2种。
* 天钢/天工系列（80级）：完成天钢系列主手制作任务获得。
* 辉煌系列（80级）：使用辉煌加工才材料制作。
* 莫雯卓越/领航星工具（90级）：完成莫雯系列制作任务获得，该系列主手制作到紫色品质时，会附加特效“高品质状态时品质上升量是通常状态的1.75倍。”

::: collapse 天钢系列工具制作简易流程

1. 开启苍穹街之后，前往伊修加德天钢机工房接任务<quest name="沉睡于工房的陈旧工具" type="plus" />，之后可以获得天钢工具。
1. 与德尼斯<pos name="伊修加德基础层" x="8" y="10.1" />对话可以购买其他职业的主手；查看、提交用于升级主手的物品，2次提交升级后可以获得龙诗工具。
1. 将主手强化至龙诗工具阶段后，可以在天钢机工房接任务<quest name="改良工具的建议" type="plus" />，然后向妮米<pos name="伊修加德基础层" x="7.9" y="10.6" />提交所需物品，获得改良型龙诗工具。
1. 将主手强化至强化型龙诗工具阶段后，可以在天钢机工房接任务<quest name="经过打磨的匠人工具" type="plus" />，然后向妮米<pos name="伊修加德基础层" x="7.9" y="10.6" />提交所需物品，获得天诗工具。
1. 将主手强化至天诗阶段后，可以在天穹街接任务<quest name="日臻完善的匠人工具" type="plus" />，然后向埃米尼<pos name="天穹街" x="9.8" y="14.6" />提交所需物品，获得天工工具。

**NOTE：**
* 所有升级所需材料均需要工票材料和普通采集材料制作，所有原材料都可以通过板子购买。
* 初始阶段到+1需要20份基础素材；+1到龙诗工具阶段需要30份基础素材；龙诗工具到改良龙诗最少需要18份素材，最多需要45份；改良龙诗到天诗最少需要21份素材，最多需要53份；天诗到天工最少需要20份素材，最多需要60份。
* 90级职业可以使用<action name="工匠的神速技巧" job="刻木匠" />制作前几个阶段所需的材料。
* 最后一步的材料需要工票/苍穹街振兴票兑换，采集材料需要从空岛采集获得，也都可以通过板子购买。但该配方属于高难度配方，不能使用工匠的神速技巧。
* 所需材料清单请查看：[制作进度、材料追踪表](https://www.kdocs.cn/l/cm9hndiVJ8eJ)

:::

::: collapse 辉煌系列工具制作简易流程

1. 在任意工票交易员处兑换<item name="辉煌工具的第一次加工素材" search />，将其制作为<item name="辉煌工具的第一次加工部件" search />（需要收藏价值在1200以上）
2. 前往林贝丝<pos name="游末邦" sub="树梢层" x="11.6" y="10.9" />处，将第一步制作的成品兑换为<item name="辉煌工具的第二次加工素材" search />（收藏价值在1420以上可以兑换2个，否则1兑1），将其制作为<item name="辉煌工具的第二次加工部件" search />（需要收藏价值在1230以上）
3. 在林贝丝<pos name="游末邦" sub="树梢层" x="11.6" y="10.9" />处，将第二步制作的成品兑换为<item name="辉煌工具的第三次加工素材" search />（收藏价值在1480以上可以兑换2个，否则1兑1），将其制作为<item name="辉煌工具的第三次加工部件" search />（需要收藏价值在1330以上）
4. 在林贝丝<pos name="游末邦" sub="树梢层" x="11.6" y="10.9" />处，将第三步制作的成品兑换为<item name="辉煌工具的最终加工素材" search />（收藏价值在1610以上可以兑换2个，否则1兑1），积攒60个辉煌工具的最终加工素材可以兑换辉煌工具。

**NOTE：**
* <item name="辉煌工具的第一次加工素材" search />可以用工票兑换，也可以直接从板子上购买。
* 所有配方均为高难配方，不能使用工匠的神速技巧。
* 如果每次部件成品均过2倍兑换线，则最少需要30个<item name="辉煌工具的第一次加工素材" search />，否则最多则需要240个。

:::

::: collapse 莫雯卓越工具制作简易流程

1. 完成90级主线<quest name="晓月之终途" type="main" />并开启中庸工艺馆和莫雯卓越商会之后，可以用生产职业在水晶都门口附近接到任务<quest name="贴近工匠需求的新工具" type="plus" />，并获得卓越工具。
1. 与秦娜娜<pos name="水晶都" x="10.4" y="7.8" />对话可以用工票购买其他职业的主手；接任务<quest name="诚信为本的改良计划" type="plus" />，提交制作好的<item name="面向收藏家的" search />〇〇（需要收藏价值在540以上），可以获得<item name="卓越工具的第一次加工部件" search />（收藏价值在900以上可以兑换3个，否则1兑1）。
1. 与乔菈·佐<pos name="水晶都" x="10.5" y="7.7" />对话可以将卓越工具和上一步获得的加工部件（60个）兑换为改良型卓越工具。
1. 接任务<quest name="回应思想的改良计划" type="plus" />，制作新的面向收藏家的〇〇（需要收藏价值在660以上），在秦娜娜处兑换，可以获得<item name="卓越工具的第二次加工部件" search />（收藏价值在1100以上可以兑换3个，否则1兑1）。
1. 与乔菈·佐对话可以将改良型卓越工具和上一步获得的加工部件（90个）兑换为水晶工具。
1. 接任务<quest name="开花结果的改良计划" type="plus" />，制作新的面向收藏家的〇〇（需要收藏价值在720以上），在秦娜娜处兑换，可以获得<item name="卓越工具的第三次加工部件" search />（收藏价值在1200以上可以兑换3个，否则1兑1）。
1. 与乔菈·佐对话可以将水晶工具和上一步获得的加工部件（90个）兑换为乔菈水晶工具。
1. 接任务<quest name="名副其实的改良计划" type="plus" />，制作新的面向收藏家的〇〇（需要收藏价值在780以上），在秦娜娜处兑换，可以获得<item name="卓越工具的第四次加工部件" search />（收藏价值在1300以上可以兑换3个，否则1兑1）。
1. 与乔菈·佐对话可以将乔菈水晶工具和上一步获得的加工部件（90个）兑换为乔菈卓绝工具。
1. 接任务<quest name="晶莹剔透的改良计划" type="plus" />，制作新的面向收藏家的〇〇（需要收藏价值在750以上），在秦娜娜处兑换，可以获得<item name="卓越工具的第五次加工部件" search />（收藏价值在1125以上可以兑换2个，1500以上可以兑换3个，否则1兑1）。
1. 与乔菈·佐对话可以将乔菈卓绝工具和上一步获得的加工部件（60个）兑换为诺弗兰特远见工具。
1. 接任务<quest name="无与伦比的改良计划" type="plus" />，制作新的面向收藏家的〇〇（需要收藏价值在800以上），在秦娜娜处兑换，可以获得<item name="卓越工具的第六次加工部件" search />（收藏价值在1200以上可以兑换2个，1600以上可以兑换3个，否则1兑1）。
1. 与乔菈·佐对话可以将诺弗兰特远见工具和上一步获得的加工部件（60个）兑换为领航星工具。

**NOTE：**
* 所有升级所需材料均需要工票材料和普通采集材料制作，所有原材料都可以通过板子购买。
* 每批制作最少需要20/30份素材，最多需要60/90份素材。
* 所需材料清单请查看：[制作进度、材料追踪表](https://www.kdocs.cn/l/cm9hndiVJ8eJ)
