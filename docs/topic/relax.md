...
> 解锁完探索笔记后，可在完成对应主线任务后，接以下任务开启对应版本探索笔记：
> * 3.0探索笔记：<Quest name="苍穹下的风景" type="plus" />
> * 4.0探索笔记：<Quest name="红莲中的风景" type="plus" />
> * 5.0探索笔记：<Quest name="黑暗中的风景" type="plus" />
> * 6.0探索笔记：<Quest name="晓月下的风景" type="plus" />
> * 7.0探索笔记（前半）：<Quest name="黄金色的风景" type="plus" />
> * 7.0探索笔记（后半）：<Quest name="黄金色的风景与新的记录" type="plus" />
