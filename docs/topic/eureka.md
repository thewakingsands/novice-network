...
在涌火之后优雷卡追加了文理技能系统，通过各种活动获得未鉴定的文理碎晶，将其交给德雷克（<Pos name="优雷卡涌火之地" :x="15.7" :y="23.9" />）就可以鉴定出各种文理碎晶。然后使用文理融合器就可以将文理碎晶融合成文理技能。
...
击杀丰水之地的NM可以获得<item name="丰水水晶" />，并有一定概率获得<item name="丰水晶簇" />级文理碎晶，<item name="丰水地带上锁的宝箱" />，点击名称可以查询具体获得数量信息及宝箱检定信息。
