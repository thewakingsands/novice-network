...
玩家完成70级主线任务<Quest name="红莲之狂潮" type="main" />后，在<Pos name="神拳痕" :x="9.8" :y="12.5" />接任务<Quest name="未知的岛屿，其名为优雷卡" type="plus" />就可以开启优雷卡探索。玩家只能使用70级的职业申请进入优雷卡岛屿，但是进入优雷卡后可以随意切换职业，玩家强度与装备属性及<i class="xiv elv"></i>元素等级相关。
...
- [踏破巴尔德西昂兵武塔——国服优雷卡BA完全攻略（NGA）](https://nga.178.com/read.php?tid=21730238)
