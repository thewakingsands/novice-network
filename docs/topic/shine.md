...
> * [古武](./relic.md)，正式名称为上古武器/黄道武器。对应的是2.X版本，装等从80~135。
> * [魂武](./anima.md)，正式名称为元灵武器。对应3.X版本，装等从170~275。
> * [优雷卡武器](./eureka-weapon.md)，禁地兵装，对应4.X版本，装等从290~405。需要在[优雷卡](./eureka.md)内完成。
> * [义军武器](./resistance.md)，对应5.x版本，装等为485~535。需要参与[南方博兹雅战线](./bozjan.md)的攻略。
> * [曼德维尔武器](./manderville.md)，对应6.x版本，装等为615~645。
...
;;;.guide .cols2
;;;.guide .col
<img src="./shine.assets/exquisite.jpg" width="350px" />

;;;

;;;.guide .col .grow

官方曾于2022年进行过一次武器设计征集大赛，在此次大赛中优胜的设计被实装于游戏中。

该系列武器需要通过亚拉戈点数兑换，然后使用零式异闻迷宫阿罗阿罗岛获得的<item name="全天强化药" />升级为发光版。是游戏中较为特殊的一系列发光武器。

[零式异闻迷宫](./variant.md)为90级高难度战斗任务，需要做好充足准备进行挑战。
