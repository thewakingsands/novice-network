...
- 如果这次不是第一把古武，直接装备上古武·天极去打fate就可以掉魂晶，收集完回来直接找光头强化即可。
...
打石头需要前往中萨于贝尔坦处对话进行，一共需要75块==星光变石==和至少75块==魔晶石==。以星光变石作为媒介，把魔晶石镶嵌到古武上。
::: segment red
嵌写不能随便打，必须从某种属性的一型魔晶石开始打。

刚开始的时候，卷轴的附魔是0/75，这时候你可以使用任意1级魔石(信仰/直击/暴击/信念/招架/技速/咏速)去强化第一次，成功率是100%

当某单一属性被强化至11(信念/信仰是7)时，你需要使用相应的2级魔石才能够继续强化该属性；<br>
当某单一属性被强化至22(信念/信仰是15)时，你需要使用相应的3级魔石才能够继续强化该属性；<br>
当某单一属性被强化至33(信念/信仰是23)时，你需要使用相应的4级魔石才能够继续强化该属性；<br>
