...
- 后文所说的所有需要通过诗学点换取的道具，未经特殊说明，则都在魔杜纳奥里亚娜( X:22.7 , Y:6.7)或田园郡希丝梅娜( X:5.8 , Y:5.3)处交换。
- 部分任务可以提前准备好材料或提前完成副任务(主要针对古武+3和+5)，可以提前把东西换出来，避免点数囤积。
从第二把古武开始，除了一开始的第一个任务，和+3地图任务以及+5的4个任务之外，别的阶段都不需要再接任务，直接找对应NPC对话，选择强化对应级别武器即可(需要提前准备好所需材料)。
- 做完古武+6之后，可以在小徒弟那里买到之前所有阶段的复制品。但是如果在中间阶段遗失了古武，你…大概…可能……只能……重新做了…吧……
:::

## 前置任务
<Quest name="传说中的武器工匠" type="plus" /> <span style="color:silver;">奈德里克·艾恩哈特(沙之家 X:6.2 , Y:5.1)</span>
...
2. 首先，要根据你接取任务的职业前往不同的蛮族，取得==朽坏的古代武器==。
3. 接下来，他会跟你说，这个古代武器太烂了没法用，要做一个==原型武器==再加以改造。
4. 武器本身需要使用来自50副本掉落的材料，并且由工匠制作完成(可以选择自备材料找人搓，也可以直接在板子上买成品)。同时武器要求必须镶嵌有==指定魔晶石==才可以，请注意不要打错石头了。
...
1. 接下来你要：前往库尔札斯中央高地开本==死化奇美拉==(第一次要去开本，以后直接排即可)。
2. 打完奇美拉，他又打发你去找罗薇娜讨古书，为了讨书需要挑战==无限城古堡==(请注意是邪教驻地无限城古堡，不要排错本了)。
3. 打完本把掉落的东西交给罗薇娜…她给你古书，回去找老头，老头要解读古书，所以给你个半成品古武，打发你去==打24只蛮族怪==(请注意要装备上半成品，否则不算)。
4. 打完回去之后，老头觉得还不过瘾，打发你去日影地打==海德拉==(第一次要去开本，以后直接排即可，请注意要装备上半成品，否则不算)。
5. 再回去，老头说终于要淬火了(我一直想不通书为啥还要淬火……)，需要你==打真三神==，然后在魔杜纳换一瓶<Item name="拉札罕淬火油" />。
...
所有这些东西都收集齐之后，把它们交给老头，就可以获得古武+0了。

然后向后转，点击老头对面的==冶炼炉==，把==古武==和<Item name="萨维奈灵药" />扔进去，就可以获得基础版的古武+1(天极)了。
...
++完成本步骤需要++：传送费若干
拿着做好的古武+1(天极)去找老头，他会让你去满世界打fate收集==魂晶==。
++要点：++务必装备上古武+1，不限制职业(只要装备+1武器就行，骑士剑盾请一起装备)。
如果不是第一把古武，直接装备上古武·天极去打fate就可以掉魂晶，掉完回来直接找老头强化即可。
目前体感魂晶掉率大约是20%，具体掉率则根据你的生日所属的守护神类型与时间有关系。还有当年人手一个的著名玄学 [魂晶计时器](http://ff14db.games.sina.com.cn/) ，如果你觉得掉率特别难受可以用用看。<span style="font-size:11.200000000000001px;">趁着妖表活动我给全职业都刷了噢耶(……</span>
...
拿着丑的不行(重点是没光)的古武去找老头子基友，一路聊天带你去找罗薇娜——的小弟。跟小弟可以用诗学换==文书(小黄书)==，不要忘了他的位置。
每本书上有3个指定副本，3个指定理符，3个指定FATE和10种指定小怪(每种3只，以前是10只hhh)。一共有9本书，你需要装备上古武(骑士需要剑盾都装备)，完成书中的任务-w-。顺序无所谓先后，看你自己喜欢就行了……如果这是你的第n(n>1)把古武，并且已经接好了后面+5所需的4个任务，可以参考伊吹大西瓜萃香提供的[参考顺序](https://bbs.nga.cn/read.php?pid=301689414)

++要点：++

- 理论上副本只需要打最后一个BOSS的时候装备古武就可以了，但是由于很容易忘，所以推荐全程古武。
- 由于同名副本很多，一定要看清你要打的具体是哪个(主要看副本前四个字…)。
- 理符任务中，“XX任务”为战斗理符，而“XX指令”是军队理符，军队理符需要军衔为协漩尉/协牙尉/协耀尉，在指定位置找“军队理符发行人”接取。
如果理符列表中没有你所要接的任务，那么需要你随便接一个理符并完成。完成并获得奖励后，理符列表才会刷新(但是也有极低概率刷新后扔没有所需理符，重复两遍即可)。
- ==如果你正在做古武的职业并非50级职业，请注意不要带着古武打高随、欧米茄等高等级副本…==
...
<table class="ui compact grey striped unstackable table">
  ...
  <tr>
    <td>乳根花簇</td>
    <td>黑衣森林东部林区 妖精领(X 24.1, Y 16.9)</td>
  </tr>
  <tr>
    <td>第四大队剑斗士</td>
    <td>西萨纳兰 西风岬</td>
  ...
  <tr>
    ...
    <td>骑兵天敌——妖蛇飞蜥</td>
    <td>库尔札斯中央高地 白云崖左上角石卫塔门口(X 8.2, Y 11.9)</td>
  </tr>
  <tr>
    <td>雷雨呼唤者——布朗格</td>
  ...
  <tr>
    <td>百灵啼持久战</td>
    <td>黑衣森林东部林区(X 28.0, Y 21.2)<br>***连续型危命，完成了前置“百灵啼防御战”后才会出现，防御战为触发型FATE，触发名为“千里眼米娜”**</td>
  </tr>
  <tr>
...
<table class="ui compact grey striped unstackable table">
  ...
  <tr>
    <td rowspan=3><span style="text-align:center;">临<br>危<br>受<br>命</span></td>
    <td>南防波堤之战 全力打击</td>
    <td>西拉诺西亚(X18,Y21)<br>***连续型危命，完成了前置“南防波堤之战 侦查行动”后才会出现**</td>
  </tr>
  <tr>
    <td>第二战斗大队</td>
    <td>南萨纳兰(X 21.2, Y 16.7)</td>
  </tr>
  <tr>
    <td>鸟人军采伐所强攻战</td>
    <td>黑衣森林北部林区(X 19.5, Y 20.0)</td>
  </tr>
  <tr>
    <td rowspan=3><span style="text-align:center;">理<br>符<br>任<br>务</span></td>
    <td>迎击任务：恶神之眼巴罗尔</td>
...
<table class="ui compact grey striped unstackable table">
  ...
  <tr>
    <td rowspan=3><span style="text-align:center;">临<br>危<br>受<br>命</span></td>
    <td>大口食人魔——加尔加梅勒</td>
    <td>库尔札斯中央高地(X 34.4, Y 13.6)<br>***比较脆的BOSS型危命，请注意提前蹲守**</td>
  </tr>
  <tr>
    <td>异国魔虫——螳螂帝王</td>
    <td>西拉诺西亚 幻影群岛(x15,y34)</td>
  </tr>
  <tr>
    <td>矿脉虫巢</td>
    <td>东萨纳兰(x25,y24)</td>
...
<table class="ui compact grey striped unstackable table">
  ...
  <tr>
    <td>妖精菌帽</td>
    <td>黑衣森林东部林区 妖精领(X 26.1, Y 13.0)</td>
  </tr>
  <tr>
    <td>精铁龟</td>
  ...
  <tr>
    <td rowspan=3><span style="text-align:center;">临<br>危<br>受<br>命</span></td>
    <td>北防波堤之战 全力打击</td>
    <td>西拉诺西亚(x20,y19)<br>***连续型危命，完成了前置“北防波堤之战 侦察行动”后才会出现**</td>
  </tr>
  <tr>
    <td>沼泽林遗恨——恩布鲁</td>
    <td>摩杜纳(X 15.7, Y 14.3)<br>***离传送点较远而且脆的BOSS型危命，请注意提前蹲守**</td>
  </tr>
  <tr>
    <td>幽谷药师——黎明药达奇希奥</td>
    <td>黑衣森林东部林区 金叶台(X 32.6, Y 14.6)<br>***离传送点较远、比较稀有，而且脆的BOSS型危命，请注意提前蹲守**</td>
  </tr>
  <tr>
    <td rowspan=3><span style="text-align:center;">理<br>符<br>任<br>务</span></td>
    <td>引导任务：失踪的警犬</td>
...
<table class="ui compact grey striped unstackable table">
  ...
  <tr>
    <td rowspan=3><span style="text-align:center;">临<br>危<br>受<br>命</span></td>
    <td>守护运输部队</td>
    <td>拉诺西亚高地(X 26.9, Y 19.2)<br>***保护NPC型任务，非常容易失败，建议蹲守**</td>
  </tr>
  <tr>
    <td>阴险的魔物</td>
  ...
  <tr>
    <td>魔界花盛开的世界</td>
    <td>摩杜纳(X 13.8, Y 13.1)<br>***别一口气拉太多hhh。**</td>
  </tr>
  <tr>
    <td rowspan=3><span style="text-align:center;">理<br>符<br>任<br>务</span></td>
    <td>讨伐任务：犯罪组织巴特商会</td>
...
<table class="ui compact grey striped unstackable table">
  ...
  <tr>
    <td rowspan=3><span style="text-align:center;">临<br>危<br>受<br>命</span></td>
    <td>力量之塔</td>
    <td>库尔札斯中央高地(X 11.3, Y 28.5)<br>***对话触发型FATE，触发点在(X 11.1, Y 30.4)**</td>
  </tr>
  <tr>
    <td>最后的斗猪王——派亚</td>
    <td>黑衣森林南部林区 兀尔德恩慧地(X 32.1, Y 25.6)</td>
  </tr>
  <tr>
    <td>友人与家人</td>
    <td>南萨纳兰(X 18.0, Y 19.1)<br>***非常脆，很容易打完，建议蹲守**</td>
  </tr>
  <tr>
    <td rowspan=3><span style="text-align:center;">理<br>符<br>任<br>务</span></td>
    <td>焚书任务：回收禁书《异界火焰的怪物》</td>
...
<table class="ui compact grey striped unstackable table">
  ...
  <tr>
    <td rowspan=3><span style="text-align:center;">临<br>危<br>受<br>命</span></td>
    <td>雪山袭击者——索贝克</td>
    <td>库尔札斯中央高地 披雪大冰壁(X 4.5, Y 21.8)</td>
  </tr>
  <tr>
    <td>试掘地强攻</td>
    <td>拉诺西亚外地 地灵军试掘地(X 25.1, Y 16.4)<br>***黑窝团二等漩兵(X 23.8, Y 16.4)对话触发**</td>
  </tr>
  <tr>
    <td>丑恶合成兽——巴杜枭</td>
    <td>东萨纳兰 火墙(X 30.2, Y 25.2)<br>***BOSS在下面，需要从地图右下角的小径走下去(不太好跳)。这个FATE不太好出，也比较脆，尽量蹲守。**</td>
  </tr>
  <tr>
    <td rowspan=3><span style="text-align:center;">理<br>符<br>任<br>务</span></td>
    <td>迎击任务：恶神之眼巴罗尔</td>
...
<table class="ui compact grey striped unstackable table">
  ...
  <tr>
    <td rowspan=3><span style="text-align:center;">临<br>危<br>受<br>命</span></td>
    <td>残忍食人魔——波罗斯克</td>
    <td>摩杜纳 银泪湖北岸 地图右上角(X 31.0, Y 5.3)</td>
  </tr>
  <tr>
    <td>以毒制毒</td>
    <td>黑衣森林东部林区 妖精岭(X 23.8 , Y 14.5)</td>
  </tr>
  <tr>
    <td>命运代言人——灰煤烟佩古基·春</td>
    <td>南萨纳兰(X 24.7, Y 26.0)</td>
  </tr>
  <tr>
    <td rowspan=3><span style="text-align:center;">理<br>符<br>任<br>务</span></td>
    <td>巡逻任务：确保补给通道的安全</td>
...
<table class="ui compact grey striped unstackable table">
  ...
  <tr>
    <td>小狐蝠</td>
    <td>黑衣森林南部林区 兀尔德恩惠地<br>黑衣森林北部林区 荣耀溪<br>**注意！这两个地方都分布有2种小狐蝠，一种比较靠外，只有30多级，另一种比较靠里(在深处)，45~47级，只有深处等级高的小狐蝠算数，外侧等级低的小狐蝠是不算的。**</td>
  </tr>
  <tr>
    <td>第四大队拳斗士</td>
    <td>西萨纳兰 西风岬</td>
  ...
  <tr>
    <td rowspan=3><span style="text-align:center;">临<br>危<br>受<br>命</span></td>
    <td>烈风勇士——怀罗克四姐妹</td>
    <td>库尔札斯中央高地(X 34.7, Y 21.2)<br>***FATE范围里分布着4个大鸟人，都打掉才算完成**</td>
  </tr>
  <tr>
    <td>遗迹的亡灵骑士——代达罗斯</td>
    <td>黑衣森林北部林区(X 22.0, Y 19.8)</td>
  </tr>
  <tr>
    <td>青磷大路</td>
    <td>北萨纳兰(X 21.7, Y 29.3)<br>***对话触发型护卫FATE，需要与&#39;慎重的商人&#39;对话触发，并保护他到目的地。**</td>
  </tr>
  <tr>
    <td rowspan=3><span style="text-align:center;">理<br>符<br>任<br>务</span></td>
    <td>讨伐任务：犯罪组织巴特商会</td>
...
贴这9本书的内容就吃了我半条命(吐魂儿)，做完这9本书回去交任务，你就获得了古武+2——魂灵。


## 古武+3 —— 天球的光芒


<p><Quest name="天球的光芒" type="plus" /> <span style="color:silver;">加尔赞 黑衣森林北部林区 (X:29.6 , Y:19.7)</span></p>

<p><Quest name="新星璀璨" type="plus" /> <span style="color:silver;">于贝尔坦 中萨纳兰 (X:23.6 , Y:13.8)</span></p>

++完成本步骤需要++：75块魔晶石，诗学/同盟徽章若干。
任务会让你先去魔杜纳换3瓶<Item name="高位附魔墨水" />，然后NPC会交给你一本《天球书卷》，然后就开始漫长的打石头之路。

打石头一共需要75块==星光变石==和至少75块==魔晶石==。星光变石作为媒介，把魔晶石镶嵌到古武上。

嵌写不能随便打，必须从某种属性的一型魔晶石开始打。

刚开始的时候，卷轴的附魔是0/75，这时候你可以使用任意1级魔石(信仰/直击/暴击/信念/招架/技速/咏速)去强化第一次，成功率是100%

当某单一属性被强化至11(信念/信仰是7)时，你需要使用相应的2级魔石才能够继续强化该属性；

当某单一属性被强化至22(信念/信仰是15)时，你需要使用相应的3级魔石才能够继续强化该属性；

当某单一属性被强化至33(信念/信仰是23)时，你需要使用相应的4级魔石才能够继续强化该属性；
(未来自带直击属性的武器无法打到上述上限属性)

由于现在古武的属性已经不重要，推荐使用便宜的石头打就可以了(今后如果你特别受不了，以后也可以使用星光变石修改武器属性)。在强化过程中，成功率也会逐渐下降，如果镶嵌失败，那么魔晶石会消失，而星光变石会保留下来。

++星光变石有以下几种途径获得：++

- 艾尔德瓦因(黑衣森林北部林区 X:29.6 , Y:19.8)接任务<Quest name="寻宝猎人的人间惨剧" type="plus" />，然后在布兰格维茵(摩杜纳 X:22.0 , Y:6.7)接任务<Quest name="神秘地图" type="plus" />，接了这个任务之后，打50/60随机任务就可以获得一个<Item name="神秘地图" />，解读地图并打开箱子后，就可以获得5块星光变石。之后《神秘地图》任务和其他日常一样在23点刷新，并可以重复接取。(这个任务和+5同一NPC的另一个任务有冲突，如果有尚未完成的神秘地图任务，就无法接取另外那个)。
- 在魔杜纳可以用75诗学换取神秘地图。
- 在自己所属的大国防联军，可以使用50点同盟徽章换取星光变石。

[神秘地图地点](https://bbs.nga.cn/read.php?tid=14920855)
...
<p><Quest name="注入武器的灵魂" type="plus" /> <span style="color:silver;">加尔赞 黑衣森林北部林区 (X:29.6 , Y:19.7)</span></p>
...
另外20级火神也是刷光热门。国际服大佬也指出，50墓园也是个不错的选择(应该是70级视角…他说自己solo一圈大概4分钟)。
...
<p><Quest name="踏上黄道的征途" type="plus" /> <span style="color:silver;">加尔赞 黑衣森林北部林区 (X:29.6 , Y:19.7)</span></p>

++完成本步骤需要++：400,000金币，800诗学，80,000军票。工匠或工匠机油或金币若干。
...
- <Quest name="滴水之恩" type="plus" /> 帕帕娜(摩杜纳 X:22.9 , Y:7.4)
- <Quest name="挑战未知的工匠" type="plus" /> 盖丁·斯塔(摩杜纳 X:22.0 , Y:6.9)
- <Quest name="激情与梦想" type="plus" /> 阿德金(中萨纳兰 X:23.7 , Y:13.7)
- <Quest name="慈母手中物" type="plus" /> 布兰格维茵(摩杜纳 X:22.0 , Y:6.7)
...
- <Item name="石绿湖水晶" />：100,000G，船头杂用商人(拉诺西亚高地 X:26.1 , Y:26.4)出售，需要1个。
- <Item name="亚拉戈树脂" />：100,000G，遗忘绿洲杂用商人(南萨纳兰 X:15.9 , Y:29.1)出售，需要1个。
- <Item name="战神沙" />：100,000G，白云崖杂用商人(库尔札斯中央高地 X:13.3 , Y:16.0)出售，需要1个。
- <Item name="黄铜壶" />：100,000G，和平苑杂用商人(黑衣森林北部林区 X:29.9 , Y:18.9)出售，需要1个。
- <Item name="熔火指环" />、<Item name="高质的木柴" />、<Item name="高质的研钵" />、<Item name="高质的钵杵" />、<Item name="高质的羊皮纸" />、<Item name="高质的安定粉" />、<Item name="秘制鳗鱼派" />、<Item name="高质的古布料" />：从白银集市杂用商人购买年代久远的XX，分解出材料后由工匠制作。一样一个。

这部分材料由于需要工匠分解，所以具体方式方法请各位斟酌。材料和最终成品在交易版上均有售。

另外根据任务进度，每个任务有4个指定的50级副本需要攻略，请注意根据任务提示选择。这些副本与+2小黄书有部分重叠，Red_Mercur 制作的[重复副本列表](https://bbs.nga.cn/read.php?pid=298005767)(参考顺序参加+2章节提供的链接)
...
<p><Quest name="力量觉醒" type="plus" /> <span style="color:silver;">加尔赞 黑衣森林北部林区 (X:29.6 , Y:19.7)</span></p>

++完成本步骤需要++：600诗学
任务会一路带你去西拉诺西亚-雨燕塔殖民地的雷蒙 (西拉诺西亚 X:34.3 , Y:31.7)，找他可以用50诗学换一块圣魂，然后和前面+4一样刷光就可以了。
...
<p><Quest name="锅嫌壶黑" type="plus" /> <span style="color:silver;">加尔赞 黑衣森林北部林区 (X:29.6 , Y:19.7)</span></p>
