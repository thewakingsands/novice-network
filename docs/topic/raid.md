...
- 目前版本（5.1）：购买一身450<i class="xiv hq"></i>，并适当升级（具体请查看[毕业装备指南](/basic/bis.md)），可挑战24人副本（尼尔复制工厂废墟）补充460装备。<br>零式1、2层/极哈迪斯 → 零式3、4层 → 绝亚历山大
- 下个版本（5.2）：购买一身480<i class="xiv hq"></i>并打满魔晶石 → 挑战红宝石神兵拿武器 → 零式5~8层。
