...
采集职业和战斗职业一样，也拥有发光主手（发光工具），主要通过成就和系列任务两种方式获得：
...
* 赐福系列/辉煌系列（80级）：完成相应数量的采集笔记成就获得。
* 天钢/天工系列（80级）：完成天钢系列主手制作任务获得。
* 莫雯卓越/领航星工具（90级）：完成莫雯系列制作任务获得，该系列主手制作到紫色品质时，会附加特效，双采为：“收藏品采集时，价值提升的发生率提高20%。”，捕鱼为：“使用强力提钩或精准提钩时，一定机率采集力消耗减轻50%。”
...
**NOTE：**
* 龙诗工具之后的采集物需要装备对应采集主手才能获得，捕鱼人的鱼饵<item name="天钢之球" />也可以在德尼斯处购买。
* 前面所有的步骤都为固定数量兑换，最后一步〇〇工具最终改良用零件则根据收藏价值有不同的兑换线。
* 所需材料清单及采集地点请查看：[制作进度、材料追踪表](https://www.kdocs.cn/l/cm9hndiVJ8eJ)
...
1. 与秦娜娜<pos name="水晶都" x="10.4" y="7.8" />对话可以购买其他职业的主手；接任务<quest name="诚信为本的改良计划" type="plus" />，提交采集到的<item name="面向收藏家的" search />〇〇，可以获得<item name="卓越工具的第一次加工部件" search />。
1. 与乔菈·佐<pos name="水晶都" x="10.5" y="7.7" />对话可以将卓越工具和上一步获得的加工部件、改良用的〇〇碎晶兑换为改良型卓越工具。
1. 接任务<quest name="回应思想的改良计划" type="plus" />，采集新的面向收藏家的〇〇，在秦娜娜处兑换，可以获得<item name="卓越工具的第二次加工部件" search />。
1. 与乔菈·佐对话可以将改良型卓越工具和上一步获得的加工部件、改良用的〇〇水晶兑换为水晶工具。
1. 接任务<quest name="开花结果的改良计划" type="plus" />，采集新的面向收藏家的〇〇，然后<aciton name="精选" />，在秦娜娜处兑换，可以获得<item name="卓越工具的第三次加工部件" search />。
1. 与乔菈·佐对话可以将水晶工具和上一步获得的加工部件、改良用的〇〇水晶兑换为乔菈水晶工具。
1. 接任务<quest name="名副其实的改良计划" type="plus" />，采集新的面向收藏家的〇〇，然后<aciton name="精选" />，在秦娜娜处兑换，可以获得<item name="卓越工具的第四次加工部件" search />。
1. 与乔菈·佐对话可以将乔菈水晶工具和上一步获得的加工部件、改良用的〇〇晶簇兑换为乔菈卓绝工具。
1. 接任务<quest name="晶莹剔透的改良计划" type="plus" />，制作新的面向收藏家的〇〇，然后<aciton name="精选" />，在秦娜娜处兑换，可以获得<item name="卓越工具的第五次加工部件" search />。
1. 与乔菈·佐对话可以将乔菈卓绝工具和上一步获得的加工部件、改良用的〇〇晶簇兑换为诺弗兰特远见工具。
1. 接任务<quest name="无与伦比的改良计划" type="plus" />，制作新的面向收藏家的〇〇，然后<aciton name="精选" />，在秦娜娜处兑换，可以获得<item name="卓越工具的第六次加工部件" search />。
1. 与乔菈·佐对话可以将诺弗兰特远见工具和上一步获得的加工部件、改良用的〇〇晶簇兑换为领航星工具。

**NOTE：**
* 所有采集物都需要装备对应主手才能获得，捕鱼人的鱼饵<item name="卓越丸子" />可以在秦娜娜处购买，也可以从板子上购买。
* 双采兑换物为一种加工部件和水晶，钓鱼兑换物为两种加工部件。加工部件在秦娜娜处兑换，最终工具在乔菈·佐处兑换。加工部件根据收藏价值有不同的兑换线。
* 所需全部材料及采集地点请查看：[兑换列表](https://ff14.huijiwiki.com/wiki/%E8%8E%AB%E9%9B%AF%E5%8D%93%E8%B6%8A%E5%B7%A5%E5%85%B7#%E5%A4%A7%E5%9C%B0%E4%BD%BF%E8%80%85%E6%9D%90%E6%96%99%E6%B8%85%E5%8D%95)
