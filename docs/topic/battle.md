...
> * [毕业装获取查询](/advanced/bis.md)

## 挑战副本类型

* **极蛮神**：每个版本的先头兵，通常提供性能优秀的武器，帮助玩家开荒更难的副本。另外还会掉落七彩坐骑，集齐同版本七彩坐骑之后，还可以召唤~~神龙~~合体坐骑。
* **幻巧战**：把以前版本的极神战斗，数值同步到当前版本，以现在的条件挑战过去的极神。每周最多可获得2次挑战奖励，具体介绍参见[宗长的幻巧拼图](/topic/daily.md#宗长的幻巧拼图（每周）)。
* **零式Raid**：偶数版本的重头戏。FF14是每2个小版本更新一次装备上限，因此打当前版本对应的零式Raid，是获得当前版本[毕业装备](/advanced/bis.md)的主要手段之一。
...
经过7.0主线<quest name="金曦之遗辉" type="main" />并讨伐过对应蛮神之后，就可以接任务<quest name="在图拉尔中心吟诗之人" type="plus" />，对话逐一开启极神。
...
万魔殿目前有边境之狱、炼净之狱，零式边狱（P1s~P4s）掉落600装备、零式炼狱（P4s~P8s）掉落630装备、零式天狱（P9s~P12s）掉落660装备。。
...
> * [深层迷宫](/topic/dd.md)（Lv 1~89）：传统Roguelike类型的迷宫，在低层可以为玩家的未满级职业练级，而高层迷宫则有相当高的难度，也会产出稀有的坐骑、宠物和外观。
> * [禁地优雷卡](/topic/eureka.md)（Lv 70+）：独立地图，有独立等级，可以制作特殊的发光武器，另外也可以获得稀有的外观、坐骑、宠物等。
> * [南方博兹雅战线](/topic/bozjan.md) （Lv 80+）：独立地图，有独立等级，可以制作特殊的发光武器，，另外也可以获得稀有的外观、坐骑、宠物等。
> * [多变迷宫](/topic/variant.md)（Lv 90）：动态难度4人迷宫，剧情难度集齐所有剧情词条后可获得对应坐骑，异闻及零式异闻难度则在零式Raid之上，可获得特殊坐骑和其他奖励。