...
FF14在设计的时候非常注重职业平衡，这种平衡包括了操作、难度和职业特性。操作简单的职业输出相对较低，没有团辅能力的职业输出就会较高，并不存在简单粗暴无脑打得高的职业。在目前版本（5.2），输出以黑魔、武士、召唤 > 忍者、武僧、龙骑、赤魔 > 机工、诗人、舞者（在不同层次的玩家中，输出排行会发生变化，比如顶级黑魔玩家的输出可以与顶级武士媲美，但底层的黑魔甚至打不到底层机工的伤害）。
