...
本页面列出了游戏当前版本可以选择的所有职业，并给出主观评分和给人留下的第一印象。同时我们为每个职业准备了详细介绍和练级、满级手法，在每个职业的**详细信息**中可以看到，也可以通过侧栏导航的**职业专题**查看。[点我查看官方职业展示视频](https://www.bilibili.com/video/BV1Bg411w743?share_source=copy_web)
