...
如果没有亲友的话请相信自己的直觉或随缘，如果已有亲友的话可洽询亲友。**橙色**的服务器有[新服奖励](/basic/levelup.md)：69级以下的职业经验获取+100%(含生产采集)。

* 陆行鸟区：红玉海；神意之地；拉诺西亚；幻影群岛；萌芽池；宇宙和音；沃仙曦染；**晨曦王座**
* 莫古力区：潮风亭；白银乡；神拳痕；白金幻象；**龙巢神殿；旅人栈桥；拂晓之间；梦羽宝境**
* 猫小胖区：紫水栈桥；延夏；静语庄园；摩杜纳；海猫茶屋；柔风海湾；**琥珀原**

;;;.guide .cols2
;;;.guide .col
<img src="./char.assets/server.png" width="350"/>
;;;

;;;.guide .col .grow

服务器开放注册时均采用**动态绝育**机制，动态绝育是指当在线玩家达到某一数值时，该服务器临时自动关闭新角色创建以及角色转入功能。若有心仪的目标服务器但发现无法创建新角色，请注意目标服务器是否在关闭期，若不在关闭期，可以改在夜间、上午等人少时段尝试。

※ 宇宙和音、沃仙曦染、海猫茶屋以及柔风海湾只接受转入，不可以转出，暂不可以创建新角色。
※ 晨曦王座、梦羽宝境和琥珀原仅开放新角色创建，不可以转入以及转出。
