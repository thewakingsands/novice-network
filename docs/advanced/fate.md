    ...
    <tbody>
      ...
      <tr>
        ...
        <td>成就<strong>荒野中的拾荒者</strong>。
          <br>是一系列 FATE，分为右半边的 “拾荒者” 系列（Lv.70）和左半边的 “寻求者” 系列（Lv.76）。先完成铰颌蚁的陷阱→萨迈尔脊骨→库伽巨人掌→洁光巨鸟，然后进入地图左半边遭遇强盗→强盗反击→探索遗迹→大老之剑。</td></tr>
      <tr>
...
<div class="md-table">
  <table class="ui compact grey striped unstackable table" style="min-width: 38em;">
    ...
    <tbody>
      <tr>
        <td>Lv.90 兽道诸神信仰：伪神降临</td>
        <td><Pos name="萨维奈岛" :x="9.2" :y="37.6" /></td>
        <td>
          <item name="明灯天王的宝珠" />，成就<strong>灯火管制</strong>。
          <br>三连 FATE，前两连 迷途的巡礼者 → 祈祷之时 会在3~5分钟内前后脚刷新，而 P3 伪神降临会在上次击杀后 1.5~3 天后刷新（否则只会以1小时为周期，前两连循环）。掉落宝珠可以交换到服装、宠物和鸟甲，点击<item name="明灯天王的宝珠" />查看详情。</td>
      </tr>
      <tr>
        <td>Lv.90 侵略兵器召回指令：破坏侵略兵器希</td>
        <td><Pos name="天外天垓" :x="34.5" :y="21.4" /></td>
        <td>
          <item name="希的螺栓" />，成就<strong>太空战士</strong>。
          <br>三连 FATE，前两连 扩建通信设备 和 保护N-6025 会以大约半小时为周期反复刷新，P3 破坏侵略兵器希会在上次击杀后 1.5~3 天后刷新（否则只会前两连循环）。掉落的螺栓可以兑换坐骑
          <item name="等级检测仪认证密钥" />，点击 <item name="希的螺栓" />查看详情。</td>
      </tr>
    </tbody>
  </table>
</div>
