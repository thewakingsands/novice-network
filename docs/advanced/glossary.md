...
* 耻辱之力：团灭/任务失败次数过多之后，会为玩家附加<Status :id="42" name="超越之力" />buff，直接为玩家增加5%~20%(根据副本不同而不同)的HP上限、魔法攻击力和物理攻击力。由于这个buff只有在挑战失败/副本攻略一定时间团灭后才能获得，也因此得名耻辱之力。
...
* 复健：指曾经通关过，但是很久没玩，已经记不清了，可能会出现较为重大的失误。
* 练习：有可能指副职练习（即副本已通关，可以正确应对机制，但职业循环不熟，可能输出较差），也有可能与开荒同义，建议进队详询。
...
## 其他用语
::: segment orange
**索引**：HW(PVP)、HH、SS、333、闪、撤、偷点、偷家、偷~、打野、19、16、15、14、12、11、10、8、、装甲车、玩具车、车头、车轮子、占点、翻白、摸点、打野、A怪、S怪、二段跳、保送、送外卖、有快递、人头狗、流星雨、秦王绕柱走、拆火、光战、光呆、萌新、豆芽、豆花、菊花、韭菜花、毒新、爷新、椰新、魔界花、大佬、皇冠、指导者、假皇冠、秃子、肝帝、狼印崽、放生、本分奶、一波、铁头、雷电法王、不动明王、陆行鸟、冰三火三、生杀风遁、赤开天门、螺旋T、陀螺T、9999、1111、2222、8888、7777、狩猎、偷情、A、B、S、海呱、地瓜、一区、二区、咕哎、库啵、鸟区、猪区、猫区、智障、鲸鱼、拉诺基亚、眼瞎、魔都
:::
::: collapse 查看详情
### PVP用语
...
* 狩猎、偷情、A、B、S：大地图上的恶名精英怪，ABS为精英怪的等级。
