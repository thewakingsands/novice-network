...
如果你不打算挑战高难度副本，那弄一身770<i class="xiv hq"></i>就可以继续享受咸鱼生活了（你也不必看下面的表格了）。
...
1. 购买一套770<i class="xiv hq"></i>。
5. 在九号解决方案接任务<quest name="阿卡狄亚的挑战者" type="plus" />开启阿卡狄亚登天斗技场系列副本，打通全部斗技场之后和加布罗<Pos name="九号解决方案" :x="22.3" :y="17.1" />对话开启零式斗技场。
4. 在图莱尤拉接任务<quest name="在图拉尔中心吟诗之人" type="plus" />开启极蛮神，挑战极神获得武器（<i class="xiv ilv"></i>775）。
4. 收集记忆卡点数兑换<i class="xiv ilv"></i>780装备，并使用材料将其升级为790（材料可以通过零式斗技场重量级获得）。
5. 用综合评级<i class="xiv ilv"></i>770以上的装备挑战零式斗技场重量级获得<i class="xiv ilv"></i>790装备及<i class="xiv ilv"></i>795武器。
6. 毕业装需要根据自己职业的副属性权重，搭配记忆点数升级的<i class="xiv ilv"></i>780装备，以及零式掉落的<i class="xiv ilv"></i>790装备（职业副属性权重可在NGA版面内搜索，或查看外网攻略）。

[7.4版本开荒及毕业配装参考](https://www.kdocs.cn/l/ceEcTzlFQBUy)，亦可使用[配装模拟器](https://asvel.github.io/ffxiv-gearing/)计算搭配自己的毕业装。
...
| 735 | 永久幽界中央终端（4人本）<br>遗忘行路雾之迹（4人本） | 永久幽界中央终端（4人本）<br>遗忘行路雾之迹（4人本） | 永久幽界中央终端（4人本）<br>遗忘行路雾之迹（4人本） |
| 750 | <item name="二型通用规格神典石" />+数理点数兑换 | 数理点数兑换 | 数理点数兑换 |
| 760 | 数理武器升级 | 数理装备升级 | 数理饰品升级 |
| 770 | 生产制作绿装（770<i class="xiv hq"></i>） | 普通斗技场重量级<br>生产制作绿装（770<i class="xiv hq"></i>） | 普通斗技场重量级<br>生产制作绿装（770<i class="xiv hq"></i>） |
| 780 | <item name="三型通用规格神典石" />+记忆点数兑换 | 记忆点数兑换 | 记忆点数兑换 |
| 790 | 记忆武器升级 | 记忆装备升级<br>零式斗技场重量级掉落 | 记忆饰品升级<br>零式斗技场重量级掉落 |
| 795 | 零式斗技场重量级掉落 | - | - |
...
在泽尔康<Pos name="九号解决方案" :x="8.6" :y="13.5" />使用记忆点数兑换780装备，记忆点数的获取请[参考本页](/advanced/currency.md#记忆神典石)。

1. 在瑟欧涅<Pos name="九号解决方案" :x="8.5" :y="13.6" />处用<item name="奔雷强化纤维" />升级780防具，用<item name="奔雷硬化药" />升级780饰品，用<item name="奔雷强化药" />升级780武器。
2. 纤维、硬化药及强化药可以使用零式斗技场重量级的低保兑换，也可以通过零式斗技场重量级直接掉落<!--，另外也可以通过狩猎点（嘉·拉克莎<Pos name="旧萨雷安" :x="11.9" :y="13.2" /> 或维尔梅塔<Pos name="拉札罕" :x="10.5" :y="7.4" />）或十二神系列副本掉落的古钱兑换（涅斯瓦孜<Pos name="拉札罕" :x="10.6" :y="10.0" />）-->。

点数武器所需的<item name="三型通用规格神典石" />可以通过普通斗技场重量级4层掉落的<item name="重量级全息投影利刃" />兑换，也可以通过零式斗技场重量级2层直接掉落。
